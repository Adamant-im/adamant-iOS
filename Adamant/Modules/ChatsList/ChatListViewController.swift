    ...
    func controller(
        ...
        case let c where c == unreadController:
            ...
            let shouldForceUpdate =
                anObject is TransferTransaction
    ...
    private func shortDescription(for transaction: ChatTransaction) -> NSAttributedString? {
        ...
        case let richMessage as RichMessageTransaction:
                ...
                let rawContent = richMessage.richContent
            {
                ...
                let replyAttributedText =
                    richMessage.additionalType == .reply
    ...
    private func shortDescription(for address: String) -> NSAttributedString? {
        ...
        if let files = chatPreservation.getPreservedFiles(for: address), !files.isEmpty {
            ...
            let text = FilePresentationHelper.getFilePresentationText(
                ...
                otherFilesCount: otherCount,
                comment: "",
                parsedWith: markdownParser,
...
extension ChatListViewController {
    ...
    func tableView(_ tableView: UITableView, didEndEditingRowAt indexPath: IndexPath?) {
        ...
        guard let deselectedIndex = indexPath,
            ...
            let chatroom = chatsController?.fetchedObjects?[safe: deselectedIndex.row]
        else { return }
        configureCell(cell, for: chatroom)
    }
...
extension UITableView {
    fileprivate func reloadRowsAndPreserveSelection(at indexPaths: [IndexPath]) {
    ...
    fileprivate func reloadDataPreservingSelection() {
