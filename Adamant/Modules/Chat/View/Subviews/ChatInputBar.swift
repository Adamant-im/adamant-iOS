...
final class ChatInputBar: InputBarAccessoryView {
    ...
    override func calculateIntrinsicContentSize() -> CGSize {
        ...
        let superTopStackViewHeight =
            topStackView.arrangedSubviews.count > .zero
...
extension ChatInputBar {
    fileprivate func updateFeeLabel() {
    ...
    fileprivate func updateIsEnabled() {
    ...
    fileprivate func updateIsAttachmentButtonEnabled() {
        let isEnabled = isEnabled && isAttachmentButtonEnabled

        attachmentButton.isEnabled = isEnabled
        attachmentButton.tintColor =
            isEnabled
            ? .adamant.primary
    ...
    fileprivate func makeAttachmentButton() -> InputBarButtonItem {
