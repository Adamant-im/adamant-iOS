...
final class AboutViewController: FormViewController {
    ...
    override func viewDidLoad() {
        ...
        // MARK: About
        form
            +++ Section(Sections.about.localized) {
                $0.tag = Sections.about.tag
            }

            // Website
            <<< buildUrlRow(
                title: Rows.website.localized,
                value: "adamant.im",
            ...
            // Whitepaper
            <<< buildUrlRow(
                title: Rows.whitepaper.localized,
                value: nil,
...
extension AboutViewController {
    ...
    fileprivate func addVibrationRow() {
