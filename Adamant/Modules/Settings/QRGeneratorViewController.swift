...
// MARK: -
final class QRGeneratorViewController: FormViewController {
        ...
        form +++ Section { $0.tag = Sections.qr.tag }
            <<< QrRow {
                ...
                let save = UIAlertAction(
                    title: String.adamant.alert.saveToPhotolibrary,
                    style: .default,
                    handler: { _ in
                ...
                let share = UIAlertAction(
                    title: String.adamant.alert.share,
                    style: .default,
                    handler: { _ in
    ...
    func generateQr() {
        ...
        case .failure(let error):
            dialogService.showError(
                withMessage: String.localizedStringWithFormat(String.adamant.qrGenerator.internalError, error.localizedDescription),
                supportEmail: true,
                error: error
            )
        }
