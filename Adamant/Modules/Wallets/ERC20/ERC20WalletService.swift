...
extension ERC20WalletService {
    func getTransactionsHistory(
        ...
        // Request
        let request =
            "(txto.eq.\(token.contractAddress),or(txfrom.eq.\(address.lowercased()),contract_to.eq.000000000000000000000000\(address.lowercased().replacingOccurrences(of: "0x", with: ""))))"
