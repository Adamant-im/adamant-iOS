        ...
        if let coinInfoNH {
            return CoinHealthCheckParameters(
                ...
                normalServiceUpdateInterval: TimeInterval(
                    coinInfoSIH?.normalUpdateInterval ?? coinInfoSNH?.normalUpdateInterval ?? coinInfoNH.normalUpdateInterval / 1000
                ),
                crucialServiceUpdateInterval: TimeInterval(
                    coinInfoSIH?.crucialUpdateInterval ?? coinInfoSNH?.crucialUpdateInterval ?? coinInfoNH.crucialUpdateInterval / 1000
                ),
                onScreenServiceUpdateInterval: TimeInterval(
                    coinInfoSIH?.onScreenUpdateInterval ?? coinInfoSNH?.onScreenUpdateInterval ?? coinInfoNH.onScreenUpdateInterval / 1000
                )
            )
        }
