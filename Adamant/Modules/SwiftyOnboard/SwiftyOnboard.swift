...
extension SwiftyOnboardDataSource {
    ...
    public func swiftyOnboardViewForBackground(_ swiftyOnboard: SwiftyOnboard) -> UIView? {
        return nil
    }

    public func swiftyOnboardOverlayForPosition(_ swiftyOnboard: SwiftyOnboard, overlay: SwiftyOnboardOverlay, for position: Double) {}
...
extension SwiftyOnboardDelegate {
    public func swiftyOnboard(_ swiftyOnboard: SwiftyOnboard, currentPage index: Int) {}
    public func swiftyOnboard(_ swiftyOnboard: SwiftyOnboard, leftEdge position: Double) {}
...
public class SwiftyOnboard: UIView, UIScrollViewDelegate {
    ...
    fileprivate func colorFrom(start color1: UIColor, end color2: UIColor, percent: CGFloat) -> UIColor {
        ...
        return UIColor(
            red: cofd(
                color1.cgColor.components![0],
                color2.cgColor.components![0],
                percent
            ),
            green: cofd(
                color1.cgColor.components![1],
                color2.cgColor.components![1],
                percent
            ),
            blue: cofd(
                color1.cgColor.components![2],
