...
protocol DialogService: AnyObject {
    ...
    func presentShareAlertFor(title: String?, string: String, types: [ShareType], excludedActivityTypes: [UIActivity.ActivityType]?, animated: Bool, from: UIView?, completion: (() -> Void)?)
