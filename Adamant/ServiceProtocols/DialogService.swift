...
protocol DialogService: AnyObject {
    ...
    func makeRenameAlert(titleFormat: String, initialText: String?, needToPresent: Bool?, url: String?, showVC: @escaping () -> Void, onRename: @escaping (String) -> Void) -> UIAlertController
