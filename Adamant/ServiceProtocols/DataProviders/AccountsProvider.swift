    ...
    var localized: String {
        ...
        case .invalidAddress(let address):
            return String.localizedStringWithFormat(
                .localized("AccountsProvider.Error.AddressNotValidFormat", comment: "AccountsProvider: Address not valid error, %@ for address"),
                address
            )
...
extension AdamantContacts {
    ...
    var messages: [String: SystemMessage] {
        ...
        case .adamantBountyWallet, .adamantNewBountyWallet:
            return [
                "chats.welcome_message": SystemMessage(
                    message: AdamantMessage.markdownText(
                        .localized("Chats.WelcomeMessage", comment: "Known contacts: Adamant welcome message. Markdown supported.")
                    ),
        ...
        case .adamantIco:
            return [
                "chats.preico_message": SystemMessage(
                    message: AdamantMessage.text(.localized("Chats.PreIcoMessage", comment: "Known contacts: Adamant pre ICO message")),
                    silentNotification: true
                ),
                "chats.ico_message": SystemMessage(
                    message: AdamantMessage.markdownText(.localized("Chats.IcoMessage", comment: "Known contacts: Adamant ICO message. Markdown supported.")),
                    silentNotification: true
                )
            ]
    ...
    var prohibitedRegions: [String] {
        ...
        case .adelina:
            return ["CN"]
        case .adamantBountyWallet, .adamantNewBountyWallet, .adamantExchange, .betOnBitcoin, .donate, .pwaBountyBot, .adamantIco, .adamantWelcomeWallet,
            .adamantSupport:
            return []
        }
    }
