...
final class ApiServiceStub: ApiService {
    func sendRequest<Output>(url: Alamofire.URLConvertible, method: Alamofire.HTTPMethod, parameters: Alamofire.Parameters?) async throws -> Output
