...
final class NativeAdamantCoreTests: XCTestCase {
    func test_encodeMessage() throws {
        let (encryptedMessage, nonce) = try XCTUnwrap(
            NativeAdamantCore().encodeMessage(
                Constants.message,
...
private enum Constants {
    ...
    static let expectedSignature =
        "328870db4ae22f0b74c829a32ae16ed3191d6dbfb13077f2ec0b35ee005270d13ff0f615de7d9a5486c4f7a66d41c99e814a7e7d2a8611d140476573266e2503"
    ...
    static let transaction = NormalizedTransaction(
        ...
        date: Date(timeIntervalSince1970: 1_738_267_672),
