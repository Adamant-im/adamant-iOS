...
class TransactionsSigningTests: LiskTestCase {
    ...
    func testSign() {
        ...
        XCTAssertEqual(
            transaction.senderPublicKeyBytes,
            [30, 226, 56, 16, 69, 67, 76, 11, 154, 150, 76, 190, 127, 133, 62, 29, 42, 114, 222, 13, 151, 152, 129, 230, 97, 229, 39, 142, 166, 196, 10, 72]
        )
    ...
    func testSignWithRealmTimestamp() {
        var transaction = LocalTransaction(.transfer, lsk: 1, recipientId: andrewAddress, timestamp: 51_262_230)
        try? transaction.sign(passphrase: exampleSecret)
    ...
    func testSecondSign() {
        ...
        XCTAssertEqual(
            ...
            "e1b31c2e4b0c84d2fcd88f99ebaa0e4eba779e699501b6c9aa127869b8a5f1cb56942c661298fed76e6e25a457ebacc99ab63c3862b26d8c9b00d728fb022b08"
        )
