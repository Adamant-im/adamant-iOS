...
extension NodesMergingService {
    fileprivate func merge(savedNodes: [Node], defaultNodes: [Node]) -> [Node] {
        var resultNodes = savedNodes
        ...
        return resultNodes
            + defaultNodes.filter { defaultNode in
...
extension Node {
    fileprivate mutating func merge(_ node: Node) {
...
extension NodeOrigin {
    fileprivate mutating func merge(_ origin: NodeOrigin) {
