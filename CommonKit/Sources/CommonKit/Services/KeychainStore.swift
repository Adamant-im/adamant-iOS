...
extension KeychainStore {
    fileprivate func configure() {
        ...
        guard
            let encryptedData = secureStorage.encrypt(
    ...
    fileprivate func getValue(_ key: String) -> Data? {
    ...
    fileprivate func setValue(_ value: Data, for key: String) {
    ...
    fileprivate func setData(_ value: Data, for key: String) {
...
extension KeychainStore {
    ...
    fileprivate func migrateUserDefaultsIfNeeded() {
        let migrated = KeychainStore.keychain[migrationKey]
